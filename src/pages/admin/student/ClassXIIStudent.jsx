  ...
  return (
    <div className="flex">
      ...
      <main className="flex-1 p-6 pt-24 md:pt-16 md:ml-64 w-full">
        <Typography variant="h5" className="mb-4 font-bold">DATA KELAS 12 (DUA BELAS)</Typography>
        ...
        <div className="flex pt-8 flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className="text-xs px-3 py-2 sm:text-sm sm:px-4 sm:py-2 border border-blue-500 text-red-500 rounded hover:bg-red-500 hover:text-white transition duration-200"
            >
              Hapus Siswa
            </button>
            <button
